...
namespace Net.Business.Services.Controllers.Sap.Gestion.Definiciones.Finanzas
{
    ...
    public class ImpuestoSapController : Controller
    {
        ...
        {
            var objectGetAll = await _repository.ImpuestoSap.GetListByFiltro(value.ReturnValue());
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetByEmpleadoVenta([FromQuery] FiltroRequestDto value)
        {
            var objectGetAll = await _repository.ImpuestoSap.GetByEmpleadoVenta(value.ReturnValue());
