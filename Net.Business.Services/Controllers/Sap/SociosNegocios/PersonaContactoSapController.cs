...
namespace Net.Business.Services.Controllers.Sap.SociosNegocios
{
    ...
    public class PersonaContactoSapController : Controller
    {
        ...
        {
            var objectGetAll = await _repository.PersonaContactoSap.GetListByFiltro(value.ReturnValue());
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> GetById([FromQuery] FiltroRequestDto value)
        {
            var objectGetAll = await _repository.PersonaContactoSap.GetById(value.ReturnValue());
