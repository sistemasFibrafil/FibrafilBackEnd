...
namespace Net.Data.Sap
{
    public class ImpuestoSapRepository : RepositoryBase<ImpuestoSapEntity>, IImpuestoSapRepository
    {
        ...
        const string SP_GET_LIST_BY_FILTRO = DB_ESQUEMA + "WEB_GES_SP_GetListImpuestoByFiltro";
        const string SP_GET_BY_CODE = DB_ESQUEMA + "WEB_GES_SP_GetImpuestoByEmpleadoVenta";
        ...
        public async Task<ResultadoTransaccion<ImpuestoSapEntity>> GetListByFiltro(FiltroRequestEntity value)
        {
            var response = new List<ImpuestoSapEntity>();
            var resultadoTransaccion = new ResultadoTransaccion<ImpuestoSapEntity>();
        ...
        public async Task<ResultadoTransaccion<ImpuestoSapEntity>> GetByEmpleadoVenta(FiltroRequestEntity value)
        {
