...
namespace Net.Data.Sap
{
    public class VehiculoSapRepository : RepositoryBase<VehiculoSapEntity>, IVehiculoSapRepository
    {
        ...
        const string SP_GET_LIST_BY_FILTRO = DB_ESQUEMA + "FIB_WEB_GE_SP_GetListVehiculoByFiltro";
        ...
        public async Task<ResultadoTransaccion<VehiculoSapEntity>> GetListByFiltro(FiltroRequestEntity value)
        {
            var response = new List<VehiculoSapEntity>();
            var resultadoTransaccion = new ResultadoTransaccion<VehiculoSapEntity>();
