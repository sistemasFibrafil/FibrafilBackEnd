...
namespace Net.Data.Sap
{
    public class CondidcionPagoSapRepository : RepositoryBase<CondicionPagoSapEntity>, ICondidcionPagoSapRepository
    {
        ...
        const string SP_GET_LIST_BY_FILTRO = DB_ESQUEMA + "WEB_GES_SP_GetListCondicionPagoByFiltro";
        const string SP_GET_BY_CODE = DB_ESQUEMA + "WEB_GES_SP_GetCondicionPagoById";
        ...
        public async Task<ResultadoTransaccion<CondicionPagoSapEntity>> GetListByFiltro(FiltroRequestEntity value)
        {
            var response = new List<CondicionPagoSapEntity>();
            var resultadoTransaccion = new ResultadoTransaccion<CondicionPagoSapEntity>();
        ...
        public async Task<ResultadoTransaccion<CondicionPagoSapEntity>> GetById(int id)
        {
